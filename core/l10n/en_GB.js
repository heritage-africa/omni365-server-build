OC.L10N.register(
    ...
    "This community release of Omni365 is unsupported and push notifications are limited." : "This community release of Omni365 is unsupported and push notifications are limited.",
    "Login" : "Login",
    ...
    "Enter your subscription key in the support app in order to increase the account limit. This does also grant you all additional benefits that Omni365 Enterprise offers and is highly recommended for the operation in companies." : "Enter your subscription key in the support app in order to increase the account limit. This does also grant you all additional benefits that Omni365 Enterprise offers and is highly recommended for the operation in companies.",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/Omni365/server/issues\" target=\"_blank\">Omni365 community</a>." : "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/Omni365/server/issues\" target=\"_blank\">Omni365 community</a>.",
    ...
    "Failed to add the public link to your Omni365" : "Failed to add the public link to your Omni365",
    "Federated user" : "Federated user",
    "user@your-Omni365.org" : "user@your-Omni365.org",
    ...
    "The Omni365 login form is disabled. Use another login option if available or contact your administration." : "The Omni365 login form is disabled. Use another login option if available or contact your administration.",
    ...
    "Line: %s" : "Line: %s",
    "Trace" : "Trace",
    "It looks like you are trying to reinstall your Omni365. However the file CAN_INSTALL is missing from your config directory. Please create the file CAN_INSTALL in your config folder to continue." : "It looks like you are trying to reinstall your Omni365. However the file CAN_INSTALL is missing from your config directory. Please create the file CAN_INSTALL in your config folder to continue.",
