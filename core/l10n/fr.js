OC.L10N.register(
    ...
    "This community release of Omni365 is unsupported and push notifications are limited." : "Cette version communautaire de Omni365 n’est pas prise en charge et les notifications push sont limitées.",
    "Login" : "S’identifier",
    ...
    "Omni365 Server" : "Serveur Omni365",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/Omni365/server/issues\" target=\"_blank\">Omni365 community</a>." : "La mise à jour a échoué. Veuillez reporter le problème à la <a href=\"https://github.com/Omni365/server/issues\" target=\"_blank\">communauté Omni365</a>.",
    ...
    "Failed to add the public link to your Omni365" : "Impossible d'ajouter le lien public à votre Omni365",
    "Federated user" : "Utilisateur fédéré",
    "user@your-Omni365.org" : "utilisateur@votre-Omni365.org",
    ...
    "Minimum search length is {minSearchLength} characters" : "La longueur minimale de recherche est de {minSearchLength} caractères",
    ...
    "The Omni365 login form is disabled. Use another login option if available or contact your administration." : "Le formulaire de connexion Omni365 est désactivé. Utilisez une autre option de connexion si disponible ou contactez un administrateur.",
    ...
    "Line: %s" : "Ligne : %s",
    "Trace" : "Trace",
    "It looks like you are trying to reinstall your Omni365. However the file CAN_INSTALL is missing from your config directory. Please create the file CAN_INSTALL in your config folder to continue." : "On dirait que vous essayez de réinstaller votre Omni365. Toutefois, le fichier CAN_INSTALL est absent de votre répertoire de configuration. Veuillez créer le fichier CAN_INSTALL dans votre dossier de configuration pour continuer.",
