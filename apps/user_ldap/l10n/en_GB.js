OC.L10N.register(
    ...
    "This application enables administrators to connect Omni365 to an LDAP-based user directory." : "This application enables administrators to connect Omni365 to an LDAP-based user directory.",
    "This application enables administrators to connect Omni365 to an LDAP-based user directory for authentication and provisioning users, groups and user attributes. Admins can configure this application to connect to one or more LDAP directories or Active Directories via an LDAP interface. Attributes such as user quota, email, avatar pictures, group memberships and more can be pulled into Omni365 from a directory with the appropriate queries and filters.\n\nA user logs into Omni365 with their LDAP or AD credentials, and is granted access based on an authentication request handled by the LDAP or AD server. Omni365 does not store LDAP or AD passwords, rather these credentials are used to authenticate a user and then Omni365 uses a session for the user ID. More information is available in the LDAP User and Group Backend documentation." : "This application enables administrators to connect Omni365 to an LDAP-based user directory for authentication and provisioning users, groups and user attributes. Admins can configure this application to connect to one or more LDAP directories or Active Directories via an LDAP interface. Attributes such as user quota, email, avatar pictures, group memberships and more can be pulled into Omni365 from a directory with the appropriate queries and filters.\n\nA user logs into Omni365 with their LDAP or AD credentials, and is granted access based on an authentication request handled by the LDAP or AD server. Omni365 does not store LDAP or AD passwords, rather these credentials are used to authenticate a user and then Omni365 uses a session for the user ID. More information is available in the LDAP User and Group Backend documentation.",
