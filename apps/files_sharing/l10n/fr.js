OC.L10N.register(
    ...
    "Sharing %s sending the password by Omni365 Talk failed because Omni365 Talk is not enabled" : "Partager %s en envoyant le mot de passe par Omni365 Talk a échoué car Omni365 Talk n'est pas activé.",
    ...
    "\"Sending the password by Omni365 Talk\" for sharing a file or folder failed because Omni365 Talk is not enabled." : "\"L'envoi du mot de passe par Omni365 Talk\" pour partager un fichier a échoué car Omni365 Talk n'est pas activé",
    ...
    "Open \"%s\"" : "Ouvrir \"%s\"",
    "This application enables people to share files within Omni365. If enabled, the admin can choose which groups can share files. The applicable people can then share files and folders with other accounts and groups within Omni365. In addition, if the admin enables the share link feature, an external link can be used to share files with other people outside of Omni365. Admins can also enforce passwords, expirations dates, and enable server to server sharing via share links, as well as sharing from mobile devices.\nTurning the feature off removes shared files and folders on the server for all share recipients, and also on the sync clients and mobile apps. More information is available in the Omni365 Documentation." : "Cette application permet aux personnes de partager des fichiers dans Omni365. Si cette option est activée, l'administrateur peut choisir quels groupes peuvent partager des fichiers. Les personnes concernées peuvent ensuite partager des fichiers et des dossiers avec d'autres comptes et groupes au sein de Omni365. De plus, si l'administrateur active la fonction de lien de partage, un lien externe peut être utilisé pour partager des fichiers avec d'autres personnes en dehors de Omni365. Les administrateurs peuvent également faire respecter les mots de passe, les dates d'expiration et permettre le partage de serveur à serveur via des liens de partage, aussi bien que le partage à partir d'appareils mobiles.\nDésactiver cette fonction supprime les fichiers et dossiers partagés sur le serveur pour tous les destinataires de partage, ainsi que sur les clients de synchronisation et les applications mobiles. Plus d'informations sont disponibles dans la documentation Omni365.",
    "People" : "Personnes",
    ...
    "For people who already have access" : "Pour les personnes qui y ont déjà accès",
    ...
    "Your browser does not support copying, please copy the link manually:" : "Votre navigateur ne prend pas en charge la copie, veuillez copier le lien manuellement :",
    "Successfully copied public link" : "Lien public copié avec succès",
    ...
    "Type a federated cloud ID" : "Tapez un ID de cloud fédéré",
    "Type an email" : "Tapez un e-mail",
    "Type an email or federated cloud ID" : "Tapez un e-mail ou un ID de cloud fédéré",
    ...
    "Add to your Omni365" : "Ajouter à votre Omni365",
    ...
    "Use this method to share files with individuals or organizations outside your organization. Files and folders can be shared via public share links and email addresses. You can also share to other Omni365 accounts hosted on different instances using their federated cloud ID." : "Cette méthode permet de partager des fichiers avec des personnes ou des organisations extérieures à votre organisation. Les fichiers et les dossiers peuvent être partagés via des liens de partage publics et des adresses e-mail. Vous pouvez également partager avec d'autres comptes Omni365 hébergés sur différentes instances en utilisant leur ID de cloud fédéré.",
