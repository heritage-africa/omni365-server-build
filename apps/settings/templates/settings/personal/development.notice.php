...
<div class="section development-notice">
	<p>
		<a href="https://docs.heritage.africa" id="open-reasons-use-nextcloud-pdf" class="link-button" target="_blank">
	...
	<p>
		<?php print_unescaped(str_replace(
			...
			$l->t('Developed by the {communityopen}Omni365 community{linkclose}, the {githubopen}source code{linkclose} is licensed under the {licenseopen}AGPL{linkclose}.')
		)); ?>
	</p>
	...
	<p class="social-button">
		<?php print_unescaped(str_replace(
			...
			[
				...
				'<svg aria-hidden="true" width="50" height="50" version="1.1" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"><circle cx="8" cy="8" r="8" fill="var(--color-text-maxcontrast)"/><path transform="translate(2,2) scale(0.019)" d="M439.8 358.7C436.5 358.3 433.1 357.9 429.8 357.4C433.2 357.8 436.5 358.3 439.8 358.7zM320 291.1C293.9 240.4 222.9 145.9 156.9 99.3C93.6 54.6 69.5 62.3 53.6 69.5C35.3 77.8 32 105.9 32 122.4C32 138.9 41.1 258 47 277.9C66.5 343.6 136.1 365.8 200.2 358.6C203.5 358.1 206.8 357.7 210.2 357.2C206.9 357.7 203.6 358.2 200.2 358.6C106.3 372.6 22.9 406.8 132.3 528.5C252.6 653.1 297.1 501.8 320 425.1C342.9 501.8 369.2 647.6 505.6 528.5C608 425.1 533.7 372.5 439.8 358.6C436.5 358.2 433.1 357.8 429.8 357.3C433.2 357.7 436.5 358.2 439.8 358.6C503.9 365.7 573.4 343.5 593 277.9C598.9 258 608 139 608 122.4C608 105.8 604.7 77.7 586.4 69.5C570.6 62.4 546.4 54.6 483.2 99.3C417.1 145.9 346.1 240.4 320 291.1z" fill="var(--color-main-background)"/></svg>',
				...
				'<a target="_blank" aria-label="{facebooktext}" rel="noreferrer noopener" href="https://www.accel-tech.net">',
				'<a target="_blank" aria-label="{xtext}" rel="noreferrer noopener" href="https://www.accel-tech.net">',
				'<a target="_blank" aria-label="{blueskytext}" rel="noreferrer noopener" https://www.accel-tech.net">',
				'<a target="_blank" aria-label="{mastodontext}" rel="noreferrer noopener" href="https://www.accel-tech.net">',
				'<a target="_blank" aria-label="{rsstext}" rel="noreferrer noopener" href="https://www.accel-tech.net">',
				'<a target="_blank" aria-label="{mailtext}" rel="noreferrer noopener" href="https://www.accel-tech.net">',
				'</a>',
