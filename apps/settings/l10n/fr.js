OC.L10N.register(
    ...
    "Omni365 help overview" : "Aperçu de l'aide Omni365",
    ...
    "Mail provider enables sending emails directly through the user's personal email account. At present, this functionality is limited to calendar invitations. It requires Omni365 Mail 4.1 and an email account in Omni365 Mail that matches the user's email address in Omni365." : "Le fournisseur de messagerie a activé l'envoi de mails directement par le compte personnel de l'utilisateur. Pour le moment, cette fonctionnalité est limitée aux invitations de calendrier. Elle requiert Omni365 Mail 4.1 et un compte de messagerie dans Omni365 Mail  dont l'adresse correspond à celle de l'utilisateur dans Omni365",
    ...
    "Detected some missing optional indices. Occasionally new indices are added (by Omni365 or installed applications) to improve database performance. Adding indices can sometimes take awhile and temporarily hurt performance so this is not done automatically during upgrades. Once the indices are added, queries to those tables should be faster. Use the command `occ db:add-missing-indices` to add them." : "Des indices facultatifs manquants ont été détectés. De nouveaux indices sont parfois ajoutés (par Omni365 ou les applications installées) pour améliorer les performances de la base de données. L'ajout d'indices peut parfois prendre un certain temps et nuire temporairement aux performances. Cette opération n'est donc pas effectuée automatiquement lors des mises à niveau. Une fois les indices ajoutés, les requêtes sur ces tables devraient être plus rapides. Utilisez la commande `occ db:add-missing-indices` pour les ajouter.",
    ...
    "The reverse proxy header configuration is incorrect. This is a security issue and can allow an attacker to spoof their IP address as visible to the Omni365." : "La configuration des entêtes du reverse proxy est incorrecte. C'est un problème de sécurité, qui peut permettre à un attaquant d'usurper l'adresse IP affichée à Omni365.",
    "Your IP address was resolved as %s" : "Votre adresse IP a été résolue comme étant %s",
    "The reverse proxy header configuration is incorrect, or you are accessing Omni365 from a trusted proxy. If not, this is a security issue and can allow an attacker to spoof their IP address as visible to the Omni365." : "La configuration des entêtes du reverse proxy est incorrecte, ou vous accédez à Omni365 depuis un proxy de confiance. Si ce n'est pas le cas, c'est un problème de sécurité, qui peut permettre à un attaquant d'usurper l'adresse IP affichée à Omni365.",
    ...
    "You are accessing your instance over a secure connection, however your instance is generating insecure URLs. This likely means that your instance is behind a reverse proxy and the Omni365 `overwrite*` config values are not set correctly." : "Vous accédez à votre instance via une connexion sécurisée, mais votre instance génère des URL non sécurisées. Cela signifie probablement que votre instance se trouve derrière un proxy inverse et que les valeurs de configuration `overwrite*` de Omni365 ne sont pas définies correctement.",
    "Your instance is generating insecure URLs. If you access your instance over HTTPS, this likely means that your instance is behind a reverse proxy and the Omni365 `overwrite*` config values are not set correctly." : "Votre instance génère des URL non sécurisées. Si vous accédez à votre instance via HTTPS, cela signifie probablement que votre instance se trouve derrière un proxy inverse et que les valeurs de configuration `overwrite*` de Omni365 ne sont pas définies correctement.",
    ...
    "Please make sure to set the \"overwrite.cli.url\" option in your config.php file to the URL that your users mainly use to access this Omni365. Suggestion: \"%s\". Otherwise there might be problems with the URL generation via cron. (It is possible though that the suggested URL is not the URL that your users mainly use to access this Omni365. Best is to double check this in any case.)" : "Veillez à définir le paramètre « overwrite.cli.url » dans votre fichier config.php avec l'URL que vos utilisateurs utilisent principalement pour accéder à ce Omni365. Suggestion : « %s ». Sinon, il pourrait y avoir des problèmes avec la génération des URL via cron. (Il est toutefois possible que l'URL suggérée ne soit pas l'URL que vos utilisateurs utilisent principalement pour accéder à ce Omni365. Le mieux est de le vérifier deux fois dans tous les cas).",
    ...
    "OPcache is configured to remove code comments. With OPcache enabled, \"opcache.save_comments=1\" must be set for Omni365 to function." : "OPcache est configuré pour retirer les commentaires du code. Avec OPcache activé, \"opcache.save_comments=1\" doit être ajouté au fichier de configuration PHP pour que Omni365 fonctionne.",
    "Omni365 is not allowed to use the OPcache API. With OPcache enabled, it is highly recommended to include all Omni365 directories with \"opcache.restrict_api\" or unset this setting to disable OPcache API restrictions, to prevent errors during Omni365 core or app upgrades." : "Omni365 n'est pas autorisé à utiliser l'API de OPcache. Avec OPcache activé, il est fortement recommandé d'inclure tous les répertoires de Omni365 dans la variable \"opcache.restrict_api\" du fichier de configuration PHP ou de désactiver ces restrictions de l'API OPcache, pour éviter les erreurs pendant les mises à jour de Omni365 ou des applications.",
    ...
    "You are currently running PHP %1$s. PHP %2$s is deprecated since Omni365 %3$s. Omni365 %4$s may require at least PHP %5$s. Please upgrade to one of the officially supported PHP versions provided by the PHP Group as soon as possible." : "Vous utilisez actuellement PHP %1$s. PHP %2$s est obsolète depuis Omni365 %3$s. Omni365 %4$s peut nécessiter au moins PHP %5$s. Veuillez effectuer la mise à niveau vers l'une des versions PHP officiellement prises en charge par PHP Group dès que possible.",
    ...
    "This is the unsupported community build of Omni365. Given the size of this instance, performance, reliability and scalability cannot be guaranteed. Push notifications are limited to avoid overloading our free service. Learn more about the benefits of Omni365 Enterprise at {link}." : "Il s'agit de la version communautaire non prise en charge de Omni365. Compte tenu de la taille de cette instance, les performances, la fiabilité et l'extensibilité ne peuvent être garanties. Les notifications push sont limitées pour éviter de surcharger notre service gratuit. Apprenez-en plus sur les avantages de Omni365 Enterprise sur {link}.",
    ...
    "Omni365 configuration file is writable" : "Le fichier de configuration Omni365 est modifiable",
    ...
    "MariaDB version 10.3 detected, this version is end-of-life and only supported as part of Ubuntu 20.04. MariaDB >=%1$s and <=%2$s is suggested for best performance, stability and functionality with this version of Omni365." : "MariaDB version 10.3 détectée, cette version est en fin de vie et n'est prise en charge que dans le cadre d'Ubuntu 20.04. MariaDB >=%1$s et <=%2$s est suggéré pour de meilleures performances, stabilité et fonctionnalités avec cette version de Omni365.",
    "MariaDB version \"%1$s\" detected. MariaDB >=%2$s and <=%3$s is suggested for best performance, stability and functionality with this version of Omni365." : "La version MariaDB \"%1$s\" a été détectée. MariaDB >=%2$s et <=%3$s est suggérée pour de meilleures performances, stabilité et fonctionnalités avec cette version de Omni365.",
    "MySQL version \"%1$s\" detected. MySQL >=%2$s and <=%3$s is suggested for best performance, stability and functionality with this version of Omni365." : "Version MySQL \"%1$s\" détectée. MySQL >=%2$s et <=%3$s est suggéré pour de meilleures performances, stabilité et fonctionnalités avec cette version de Omni365.",
    "PostgreSQL version \"%1$s\" detected. PostgreSQL >=%2$s and <=%3$s is suggested for best performance, stability and functionality with this version of Omni365." : "PostgreSQL version \"%1$s\" détecté. PostgreSQL >=%2$s et <=%3$s est suggérée pour de meilleures performances, stabilité et fonctionnalités avec cette version de Omni365.",
    ...
    "64-bit" : "64 bits",
    "It seems like you are running a 32-bit PHP version. Omni365 needs 64-bit to run well. Please upgrade your OS and PHP to 64-bit!" : "Il semblerait que vous exécutiez une version 32 bits de PHP. Omni365 nécessite 64 bits pour fonctionner correctement. Veuillez mettre votre système d'exploitation et PHP à niveau vers du 64 bits !",
    ...
    "- %.1f GiB available in %s (Omni365 temporary directory)" : "- %.1f Gio disponible sur dans %s (répertoire temporaire de Omni365)",
    ...
    "Your web server is not properly set up to deliver .{extension} files. This is typically an issue with the Nginx configuration. For Omni365 15 it needs an adjustment to also deliver .{extension} files. Compare your Nginx configuration to the recommended configuration in our documentation." : "Votre serveur Web n'est pas correctement configuré pour distribuer les fichiers .{extension} . Il s'agit généralement d'un problème lié à la configuration Nginx. Pour Omni365 15, un ajustement est nécessaire pour distribuer également les fichiers .{extension} . Comparez votre configuration Nginx à la configuration recommandée dans notre documentation.",
    ...
    "Omni365 settings" : "Paramètres Omni365",
    ...
    "Remove" : "Retirer",
    "Featured" : "En vedette",
    "This app is supported via your current Omni365 subscription." : "Cette application bénéficie d'un support grâce à votre abonnement Omni365.",
    ...
    "It is important for the security and performance of your instance that everything is configured correctly. To help you with that we are doing some automatic checks. Please see the linked documentation for more information." : "Il est important pour la sécurité et la performance de votre instance que celle-ci soit correctement configurée. Afin de vous aider, votre instance Omni365 effectue des vérifications automatiques. Pour de plus amples informations, veuillez consulter la documentation liée.",
    ...
    "Forum" : "Forum",
    "Omni365 help & privacy resources" : "Ressources d’aide Omni365 & de confidentialité",
    ...
    "This community release of Omni365 is unsupported and instant notifications are unavailable." : "Cette version communautaire de Omni365 n'est pas supportée et les notifications push ne sont pas disponibles.",
    ...
    "This app has no minimum Omni365 version assigned. This will be an error in the future." : "Cette application n’a pas de version minimum Omni365 exigée. Ce sera considéré comme une erreur à l’avenir.",
    "This app has no maximum Omni365 version assigned. This will be an error in the future." : "Cette application n’a pas de version maximum Omni365 exigée. Ce sera considéré comme une erreur à l’avenir.",
    "Loading accounts …" : "Chargement des comptes …",
    "Set account as admin for …" : "Définir en tant qu'administrateur pour",
    "_{userCount} account …_::_{userCount} accounts …_" : ["{userCount} compte…","{userCount} comptes…","{userCount} comptes…"],
    "In case of lost device or exiting the organization, this can remotely wipe the Omni365 data from all devices associated with {userid}. Only works if the devices are connected to the internet." : "En cas de perte d'appareil ou si vous quittez un groupe ou une organisation, cela pourra supprimer les données de tous les appareils associés à {userid}. Ne fonctionne que si les appareils associés sont connectés à internet.",
    "Failed to load subadmin groups with details" : "Échec du chargement des sous-administrateurs de groupes avec les détails",
    "Loading account …" : "Chargement du compte…",
    "Adding your device …" : "Ajout de votre périphérique…",
    "For performance reasons, when you enable encryption on a Omni365 server only new and changed files are encrypted." : "Pour des raisons de performance, quand vous activez le chiffrement sur un serveur Omni365, seuls les fichiers nouveaux et modifiés sont chiffrés.",
    "{progress}% Deploying …" : "{progress}% Déploiement…",
    "{progress}% Initializing …" : "{progress}% Initialisation…",
    "This app is not marked as compatible with your Omni365 version. If you continue you will still be able to install the app. Note that the app might not work as expected." : "Cette application n'est pas indiquée comme étant compatible avec votre version de Omni365. Si vous continuez vous pourrez toujours installer l'app. Notez cependant qu'elle pourrait ne pas fonctionner comme prévu.",
