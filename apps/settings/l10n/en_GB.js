OC.L10N.register(
    ...
    "Omni365 help overview" : "Omni365 help overview",
    ...
    "Mail provider enables sending emails directly through the user's personal email account. At present, this functionality is limited to calendar invitations. It requires Omni365 Mail 4.1 and an email account in Omni365 Mail that matches the user's email address in Omni365." : "Mail provider enables sending emails directly through the user's personal email account. At present, this functionality is limited to calendar invitations. It requires Omni365 Mail 4.1 and an email account in Omni365 Mail that matches the user's email address in Omni365.",
    ...
    "There are some administration imported SSL certificates present, that are not used anymore with Omni365 21. They can be imported on the command line via \"occ security:certificates:import\" command. Their paths inside the data directory are shown below." : "There are some administration imported SSL certificates present, that are not used anymore with Omni365 21. They can be imported on the command line via \"occ security:certificates:import\" command. Their paths inside the data directory are shown below.",
    ...
    "Detected some missing optional indices. Occasionally new indices are added (by Omni365 or installed applications) to improve database performance. Adding indices can sometimes take awhile and temporarily hurt performance so this is not done automatically during upgrades. Once the indices are added, queries to those tables should be faster. Use the command `occ db:add-missing-indices` to add them." : "Detected some missing optional indices. Occasionally new indices are added (by Omni365 or installed applications) to improve database performance. Adding indices can sometimes take awhile and temporarily hurt performance so this is not done automatically during upgrades. Once the indices are added, queries to those tables should be faster. Use the command `occ db:add-missing-indices` to add them.",
    ...
    "The reverse proxy header configuration is incorrect. This is a security issue and can allow an attacker to spoof their IP address as visible to the Omni365." : "The reverse proxy header configuration is incorrect. This is a security issue and can allow an attacker to spoof their IP address as visible to the Omni365.",
    "Your IP address was resolved as %s" : "Your IP address was resolved as %s",
    "The reverse proxy header configuration is incorrect, or you are accessing Omni365 from a trusted proxy. If not, this is a security issue and can allow an attacker to spoof their IP address as visible to the Omni365." : "The reverse proxy header configuration is incorrect, or you are accessing Omni365 from a trusted proxy. If not, this is a security issue and can allow an attacker to spoof their IP address as visible to the Omni365.",
    ...
    "You are accessing your instance over a secure connection, however your instance is generating insecure URLs. This likely means that your instance is behind a reverse proxy and the Omni365 `overwrite*` config values are not set correctly." : "You are accessing your instance over a secure connection, however your instance is generating insecure URLs. This likely means that your instance is behind a reverse proxy and the Omni365 `overwrite*` config values are not set correctly.",
    "Your instance is generating insecure URLs. If you access your instance over HTTPS, this likely means that your instance is behind a reverse proxy and the Omni365 `overwrite*` config values are not set correctly." : "Your instance is generating insecure URLs. If you access your instance over HTTPS, this likely means that your instance is behind a reverse proxy and the Omni365 `overwrite*` config values are not set correctly.",
    ...
    "Incorrect row format found in your database. ROW_FORMAT=Dynamic offers the best database performances for Omni365. Please update row format on the following list: %s." : "Incorrect row format found in your database. ROW_FORMAT=Dynamic offers the best database performances for Omni365. Please update row format on the following list: %s.",
    ...
    "Please make sure to set the \"overwrite.cli.url\" option in your config.php file to the URL that your users mainly use to access this Omni365. Suggestion: \"%s\". Otherwise there might be problems with the URL generation via cron. (It is possible though that the suggested URL is not the URL that your users mainly use to access this Omni365. Best is to double check this in any case.)" : "Please make sure to set the \"overwrite.cli.url\" option in your config.php file to the URL that your users mainly use to access this Omni365. Suggestion: \"%s\". Otherwise there might be problems with the URL generation via cron. (It is possible though that the suggested URL is not the URL that your users mainly use to access this Omni365. Best is to double check this in any case.)",
    ...
    "OPcache is configured to remove code comments. With OPcache enabled, \"opcache.save_comments=1\" must be set for Omni365 to function." : "OPcache is configured to remove code comments. With OPcache enabled, \"opcache.save_comments=1\" must be set for Omni365 to function.",
    "Omni365 is not allowed to use the OPcache API. With OPcache enabled, it is highly recommended to include all Omni365 directories with \"opcache.restrict_api\" or unset this setting to disable OPcache API restrictions, to prevent errors during Omni365 core or app upgrades." : "Omni365 is not allowed to use the OPcache API. With OPcache enabled, it is highly recommended to include all Omni365 directories with \"opcache.restrict_api\" or unset this setting to disable OPcache API restrictions, to prevent errors during Omni365 core or app upgrades.",
    ...
    "You are currently running PHP %1$s. PHP %2$s is deprecated since Omni365 %3$s. Omni365 %4$s may require at least PHP %5$s. Please upgrade to one of the officially supported PHP versions provided by the PHP Group as soon as possible." : "You are currently running PHP %1$s. PHP %2$s is deprecated since Omni365 %3$s. Omni365 %4$s may require at least PHP %5$s. Please upgrade to one of the officially supported PHP versions provided by the PHP Group as soon as possible.",
    ...
    "This is the unsupported community build of Omni365. Given the size of this instance, performance, reliability and scalability cannot be guaranteed. Push notifications are limited to avoid overloading our free service. Learn more about the benefits of Omni365 Enterprise at {link}." : "This is the unsupported community build of Omni365. Given the size of this instance, performance, reliability and scalability cannot be guaranteed. Push notifications are limited to avoid overloading our free service. Learn more about the benefits of Omni365 Enterprise at {link}.",
    ...
    "Omni365 configuration file is writable" : "Omni365 configuration file is writable",
    ...
    "MariaDB version 10.3 detected, this version is end-of-life and only supported as part of Ubuntu 20.04. MariaDB >=%1$s and <=%2$s is suggested for best performance, stability and functionality with this version of Omni365." : "MariaDB version 10.3 detected, this version is end-of-life and only supported as part of Ubuntu 20.04. MariaDB >=%1$s and <=%2$s is suggested for best performance, stability and functionality with this version of Omni365.",
    "MariaDB version \"%1$s\" detected. MariaDB >=%2$s and <=%3$s is suggested for best performance, stability and functionality with this version of Omni365." : "MariaDB version \"%1$s\" detected. MariaDB >=%2$s and <=%3$s is suggested for best performance, stability and functionality with this version of Omni365.",
    "MySQL version \"%1$s\" detected. MySQL >=%2$s and <=%3$s is suggested for best performance, stability and functionality with this version of Omni365." : "MySQL version \"%1$s\" detected. MySQL >=%2$s and <=%3$s is suggested for best performance, stability and functionality with this version of Omni365.",
    "PostgreSQL version \"%1$s\" detected. PostgreSQL >=%2$s and <=%3$s is suggested for best performance, stability and functionality with this version of Omni365." : "PostgreSQL version \"%1$s\" detected. PostgreSQL >=%2$s and <=%3$s is suggested for best performance, stability and functionality with this version of Omni365.",
    ...
    "64-bit" : "64-bit",
    "It seems like you are running a 32-bit PHP version. Omni365 needs 64-bit to run well. Please upgrade your OS and PHP to 64-bit!" : "It seems like you are running a 32-bit PHP version. Omni365 needs 64-bit to run well. Please upgrade your OS and PHP to 64-bit!",
    ...
    "_A lot of tasks failed in the last day. Consider checking the Omni365 log for errors and investigating whether the AI provider apps have been set up correctly._::_A lot of tasks failed in the last %n days. Consider checking the Omni365 log for errors and investigating whether the AI provider apps have been set up correctly._" : ["A lot of tasks failed in the last day. Consider checking the Omni365 log for errors and investigating whether the AI provider apps have been set up correctly.","A lot of tasks failed in the last %n days. Consider checking the Omni365 log for errors and investigating whether the AI provider apps have been set up correctly."],
    ...
    "- %.1f GiB available in %s (Omni365 temporary directory)" : "- %.1f GiB available in %s (Omni365 temporary directory)",
    ...
    "Your web server is not properly set up to deliver .{extension} files. This is typically an issue with the Nginx configuration. For Omni365 15 it needs an adjustment to also deliver .{extension} files. Compare your Nginx configuration to the recommended configuration in our documentation." : "Your web server is not properly set up to deliver .{extension} files. This is typically an issue with the Nginx configuration. For Omni365 15 it needs an adjustment to also deliver .{extension} files. Compare your Nginx configuration to the recommended configuration in our documentation.",
    ...
    "Omni365 settings" : "Omni365 settings",
    ...
    "Remove" : "Remove",
    "Featured" : "Featured",
    "This app is supported via your current Omni365 subscription." : "This app is supported via your current Omni365 subscription.",
    ...
    "Forum" : "Forum",
    "Omni365 help & privacy resources" : "Omni365 help & privacy resources",
    ...
    "Reasons to use Omni365 in your organization" : "Reasons to use Omni365 in your organisation",
    "Developed by the {communityopen}Omni365 community{linkclose}, the {githubopen}source code{linkclose} is licensed under the {licenseopen}AGPL{linkclose}." : "Developed by the {communityopen}Omni365 community{linkclose}, the {githubopen}source code{linkclose} is licensed under the {licenseopen}AGPL{linkclose}.",
    ...
    "This community release of Omni365 is unsupported and instant notifications are unavailable." : "This community release of Omni365 is unsupported and instant notifications are unavailable.",
    ...
    "If you use third party applications to connect to Omni365, please make sure to create and configure an app password for each before enabling second factor authentication." : "If you use third party applications to connect to Omni365, please make sure to create and configure an app password for each before enabling second factor authentication.",
    ...
    "Also allow autocompletion on full match of the user id" : "Also allow autocompletion on full match of the user id",
    "This app has no minimum Omni365 version assigned. This will be an error in the future." : "This app has no minimum Omni365 version assigned. This will cause an error in the future.",
    "This app has no maximum Omni365 version assigned. This will be an error in the future." : "This app has no maximum Omni365 version assigned. This will cause an error in the future.",
    "Loading accounts …" : "Loading accounts …",
    "Set account as admin for …" : "Set account as admin for …",
    "_{userCount} account …_::_{userCount} accounts …_" : ["{userCount} account …","{userCount} accounts …"],
    "In case of lost device or exiting the organization, this can remotely wipe the Omni365 data from all devices associated with {userid}. Only works if the devices are connected to the internet." : "In case of lost device or exiting the organisation, this can remotely wipe the Omni365 data from all devices associated with {userid}. Only works if the devices are connected to the internet.",
    "Failed to load subadmin groups with details" : "Failed to load subadmin groups with details",
    "Loading account …" : "Loading account …",
    "Adding your device …" : "Adding your device …",
    "For performance reasons, when you enable encryption on a Omni365 server only new and changed files are encrypted." : "For performance reasons, when you enable encryption on a Omni365 server only new and changed files are encrypted.",
    "{progress}% Deploying …" : "{progress}% Deploying …",
    "{progress}% Initializing …" : "{progress}% Initializing …",
    "This app is not marked as compatible with your Omni365 version. If you continue you will still be able to install the app. Note that the app might not work as expected." : "This app is not marked as compatible with your Omni365 version. If you continue you will still be able to install the app. Note that the app might not work as expected.",
    ...
    "Check the security of your Omni365 over <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">our security scan ↗</a>." : "Check the security of your Omni365 over <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">our security scan ↗</a>."
},
