OC.L10N.register(
    ...
    "Expected filesize of %1$s but read (from Omni365 client) and wrote (to Omni365 storage) %2$s. Could either be a network problem on the sending side or a problem writing to the storage on the server side." : "Taille du fichier attendue : %1$s mais taille du fichier lue (depuis le client Omni365) et écrit (dans le stockage Omni365) : %2$s. Cela peut être un problème de réseau au niveau du client ou un problème de stockage au niveau du serveur.",
    ...
    "Welcome to Omni365 Calendar!\n\nThis is a sample event - explore the flexibility of planning with Omni365 Calendar by making any edits you want!\n\nWith Omni365 Calendar, you can:\n- Create, edit, and manage events effortlessly.\n- Create multiple calendars and share them with teammates, friends, or family.\n- Check availability and display your busy times to others.\n- Seamlessly integrate with apps and devices via CalDAV.\n- Customize your experience: schedule recurring events, adjust notifications and other settings." : "Bienvenue dans Omni365 Calendar !\n\nCeci est un exemple d'événement. Découvrez la flexibilité de la planification avec Omni365 Calendar en effectuant toutes les modifications que vous souhaitez !\n\nAvec Omni365 Calendar, vous pouvez :\n- Créer, modifier et gérer des événements sans effort.\n- Créer plusieurs calendriers et les partager avec vos collègues, vos amis ou votre famille.\n- Vérifier vos disponibilités et afficher vos périodes d'indisponibilité à d'autres personnes.\n- Intégrer de manière transparente des applications et des appareils via CalDAV.\n- Personnaliser votre expérience : planifier des événements récurrents, ajuster les notifications et d'autres paramètres.",
    ...
    "Example content serves to showcase the features of Omni365. Default content is shipped with Omni365, and can be replaced by custom content." : "Les exemples de contenu servent à présenter les fonctionnalités de Omni365. Le contenu par défaut est fourni avec Omni365 et peut être remplacé par du contenu personnalisé.",
