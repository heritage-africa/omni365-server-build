OC.L10N.register(
    ...
    "Please check the Omni365 and server log files for errors." : "Veuillez vérifier les fichiers de log de Omni365 et du serveur pour les erreurs.",
    ...
    "Displays update notifications for Omni365, app updates, and provides the SSO for the updater." : "Affiche les notifications de mise à jour des applications et de Omni365 et fournit l'authentification unique SSO pour le programme de mise à jour.",
    ...
    "You can always update to a newer version. But you can never downgrade to a more stable version." : "Vous pouvez à tout moment mettre à jour votre instance Omni365 vers une version plus récente. Vous ne pourrez cependant jamais revenir à une version antérieure en sélectionnant un canal plus stable.",
    ...
    "<strong>All</strong> apps have a compatible version for this Omni365 version available." : "<strong>Toutes</strong> les applications ont une version compatible avec cette version de Omni365.",
    "_<strong>%n</strong> app has no compatible version for this Omni365 version available._::_<strong>%n</strong> apps have no compatible version for this Omni365 version available._" : ["<strong>%n</strong> application n'a pas de version compatible pour cette version de Omni365 disponible.","<strong>%n</strong> applications n'ont pas de version compatible pour cette version de Omni365 disponible.","<strong>%n</strong> applications n'ont pas de version compatible avec cette version de Omni365 disponible."],
    "For enterprise use. Provides always the latest patch level, but will not update to the next major release immediately. That update happens once Omni365 GmbH has done additional hardening and testing for large-scale and mission-critical deployments. This channel is only available to customers and provides the Omni365 Enterprise package." : "Pour les entreprises. Fournit toujours le correctif le plus récent, mais ne mettra pas à jour dans la version majeure suivante immédiatement. Cette mise à jour sera effectuée une fois que Omni365 GmbH aura effectué les renforcements et tests pour permettre un déploiement en production et à grande échelle. Ce canal de mise à jour est seulement disponible pour les clients et fournit le paquet Omni365 Entreprise."
},
